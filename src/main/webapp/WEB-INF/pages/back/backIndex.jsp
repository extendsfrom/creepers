...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <link rel="stylesheet" type="text/css" href="src/main/webapp/WEB-INF/pages/back/themes/icon.css" />
    <link rel="stylesheet" type="text/css" href="src/main/webapp/WEB-INF/pages/back/themes/default/easyui.css" />
    <script type="text/javascript" src="src/main/webapp/WEB-INF/pages/back/js/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="src/main/webapp/WEB-INF/pages/back/js/jquery.easyui.min.js"></script>
